...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FbLibraryAccessors laccForFbLibraryAccessors = new FbLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>fb</b>
     */
    public FbLibraryAccessors getFb() {
        return laccForFbLibraryAccessors;
    }
    ...
    public static class FbLibraryAccessors extends SubDependencyFactory {

        public FbLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>koinBom</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getBom() {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>io.insert-koin:koin-android</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koinBom</b> with value <b>3.5.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleProcess</b> with value <b>2.8.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesAds</b> with value <b>23.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        private final AdsBundleAccessors baccForAdsBundleAccessors = new AdsBundleAccessors(objects, providers, config, attributesFactory, capabilityNotationParser);

        public BundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Group of bundles at <b>bundles.ads</b>
         */
        public AdsBundleAccessors getAds() {
            return baccForAdsBundleAccessors;
        }

    }

    public static class AdsBundleAccessors extends BundleFactory {

        public AdsBundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }

        /**
         * Dependency bundle provider for <b>ads.related</b> which contains the following dependencies:
         * <ul>
         ...
         */
        public Provider<ExternalModuleDependencyBundle> getRelated() {
            return createBundle("ads.related");
        }
